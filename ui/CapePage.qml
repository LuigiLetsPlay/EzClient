...
Item {
    ...
    ColumnLayout {
        ...
        Rectangle {
            Layout.fillWidth: true; Layout.preferredHeight: 104; radius: 14
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Image { id: activeCapeImage; anchors.fill: parent; anchors.margins: 8; source: typeof accountController !== "undefined" ? accountController.capeTextureUrl : ""; fillMode: Image.PreserveAspectFit; visible: source !== "" }
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                Layout.fillWidth: true; Layout.fillHeight: true; radius: 9; color: EzTheme.surface3; clip: true
                                Image { anchors.fill: parent; anchors.margins: 10; source: modelData.imageUrl || ""; fillMode: Image.PreserveAspectFit; asynchronous: true }
                            }
                            ...
                            RowLayout {
                                ...
                                EzButton { text: "Nutzen"; onClicked: accountController.activateCommunityCape(modelData.imageUrl) }
                            }
