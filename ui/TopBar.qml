        ...
        Row {
            ...
            Repeater {
                ...
                model: [
                    ...
                    { id: "versions",       labelKey: "nav_versions",       fallback: "Versionen",        icon: "download.svg" },
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    text: "Update v" + (profileController ? profileController.ezClientLatestVersion : "2.0.0")
                    font.family: EzTheme.mcFontFamily
                    font.pixelSize: 10
                    font.bold: true
        ...
        // Player Avatar & Username Pill
        Rectangle {
            id: accPill
            z: 30
            height: 34
            width: Math.max(120, Math.min(240, accRow.implicitWidth + 24))
            radius: 17
                ...
                contentItem: ColumnLayout {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            height: 42
                            radius: EzTheme.radiusSm
                            color: modelData.active ? EzTheme.surfaceActive : (savedAccountMouse.containsMouse ? EzTheme.surface3 : "transparent")
                            border.color: modelData.active ? EzTheme.accent : "transparent"
                            border.width: 1
                            ...
                            RowLayout {
                                ...
                                spacing: 8
                                Rectangle {
                                    width: 28; height: 28; radius: 14; color: EzTheme.surface3; clip: true
                                    Image { anchors.fill: parent; source: modelData.avatarUrl; fillMode: Image.PreserveAspectCrop }
                                }
                                ColumnLayout {
                                ...
                                Rectangle {
                                    ...
                                    color: removeAccountMouse.containsMouse ? "#3B1119" : "transparent"
                                    Text { anchors.centerIn: parent; text: "×"; color: EzTheme.danger; font.pixelSize: 16 }
                                    MouseArea {
                                        id: removeAccountMouse; anchors.fill: parent; hoverEnabled: true
                                        onClicked: accountController.removeAccount(modelData.uuid)
                                    }
                                }
                            }
                            MouseArea {
                                id: savedAccountMouse; anchors.fill: parent; z: 0; hoverEnabled: true
                                onClicked: if (!modelData.active) accountController.switchAccount(modelData.uuid)
                            }
                        }
                    }
