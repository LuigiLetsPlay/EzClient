...
public final class ModuleManager {
    ...
    public void saveConfig() {
        try {
            ...
            File file = new File(dir, "legacy_modules.json");
            ...
            System.err.println("[EzClient] Failed to save legacy modules config: " + t.getMessage());
        }
    }
    ...
    public void loadConfig() {
        try {
            ...
            System.err.println("[EzClient] Failed to load legacy modules config: " + t.getMessage());
        }
    }
}
