...
/**
 * Modern Glassmorphism Dashboard for Legacy Minecraft (1.8.9 & 1.12.2).
 */
public class EzHubScreen extends Screen {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        // 2. Glassmorphism Main Window Panel (with gradient and subtle glow)
        ...
        RenderUtils.drawString("v" + EzClientMod_1_8.CLIENT_VERSION, panelX + 146, panelY + 12, 0xFF55FF55, false);
                ...
                for (Module m : modules) {
                    ...
                    if (mouseY >= currentY && mouseY <= currentY + itemH && mouseY >= listY && mouseY <= listY + listH) {
                        ...
                        if (mouseX >= gearX && mouseX <= gearX + gearW && mouseY >= btnY && mouseY <= btnY + gearH) {
                            if (client != null) client.setScreen(new ModuleSettingsScreen(this, m));
                            return;
                        }
                        ...
                        // Clicking anywhere else on row toggles module
                        m.toggle();
                        ModuleManager.getInstance().saveConfig();
                        return;
                    }
