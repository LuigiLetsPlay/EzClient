...
public final class EzHubScreen extends Screen {
    ...
    @Override protected void init() {
        ...
        addRenderableWidget(new EzButton(x + 22, y + 92, (panelWidth - 56) / 2, 116, Component.literal("Modules"), true,
                b -> minecraft.gui.setScreen(new EzClientScreen(this))));
        addRenderableWidget(new EzButton(x + 34 + (panelWidth - 56) / 2, y + 92, (panelWidth - 56) / 2, 116, Component.literal("HUD Editor"), false,
                b -> minecraft.gui.setScreen(new HudEditorScreen(this))));
        addRenderableWidget(new EzButton(x + panelWidth - 88, y + 18, 66, 22, Component.literal("Close"), false, b -> onClose()));
    }
    @Override public void extractRenderState(GuiGraphicsExtractor g, int mx, int my, float d) {
        ...
        g.blitSprite(RenderPipelines.GUI_TEXTURED, EZCLIENT_ICON, x + 26, y + 26, 28, 28);
        g.text(font, "EzClient", x + 70, y + 26, 0xFFFFFFFF);
        g.text(font, "Your game, refined.", x + 70, y + 42, 0xFFABB5C7);
        g.text(font, "MODULES", x + 34, y + 76, 0xFFABB5C7);
        g.text(font, "HUD EDITOR", x + 46 + (panelWidth - 56) / 2, y + 76, 0xFFABB5C7);
